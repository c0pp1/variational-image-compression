...
def main():
    ...
    for l in lambdas:
        ...
        # save model
        model_name = f"model_ffp_{ch_format}_epochs{epochs}_{norm_str}_l{l}_{current_time}_cr3.h5"
        model_path = constants.MODEL_FOLDER + model_name
        vae.save_weights(model_path)
        
        # save losses in .h5 file
        losses_name = f"losses_ffp_{ch_format}_epochs{epochs}_{norm_str}_l{l}_{current_time}_cr3.h5"
